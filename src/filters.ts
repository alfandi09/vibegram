...
export const isGroup: FilterFn = ctx =>
...
export const hasText: FilterFn = ctx =>
    typeof ctx.message?.text === 'string' && ctx.message.text.length > 0;

/** Matches messages containing photos */
export const hasPhoto: FilterFn = ctx =>
