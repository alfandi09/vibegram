...
<FeatureGrid title="Workflow I18n" description="Lokalkan reply bot dengan deteksi locale, dictionary, dan helper terdekat dengan handler.">
  <FeatureCard title="Deteksi locale" description="Ambil bahasa dari user, chat, atau konfigurasi middleware." href="#setup" cta="Buka setup" />
  <FeatureCard title="Helper terjemahan" description="Gunakan `ctx.i18n` dari handler setelah middleware terpasang." href="#penggunaan" cta="Buka penggunaan" />
  <FeatureCard title="Fallback" description="Sediakan default locale agar translation yang hilang tidak merusak reply." href="#fallback" cta="Buka fallback" />
</FeatureGrid>
