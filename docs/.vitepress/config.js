export default {
  ...
  head: [
    ...
    ['meta', { property: 'og:description', content: 'Modern, enterprise-grade Telegram Bot Framework for Node.js. Full Bot API v9.6 coverage.' }],
  ],
  ...
  themeConfig: {
    nav: [
      ...
      { text: 'Changelog', link: 'https://github.com/alfandi09/vibegram/blob/main/CHANGELOG.md' }
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/alfandi09/vibegram' }
    ],
