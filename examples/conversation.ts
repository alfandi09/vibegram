...
export function createConversationExample(token: string = 'YOUR_BOT_TOKEN') {
    ...
    return { bot, conversation: conv };
}

if (require.main === module) {
    const { bot } = createConversationExample(process.env.BOT_TOKEN || 'YOUR_BOT_TOKEN');
